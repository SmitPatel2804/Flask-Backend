...
from service.unique_key_service import key_blueprint, init_mongo as init_mongo_key  # ✅ Import unique key service init
...
def create_app():
    ...
    app.register_blueprint(key_blueprint, url_prefix='/api')  # ✅ Register key services

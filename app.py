...
def create_app():
    ...
    app.config['MONGO_URI'] = os.getenv("MONGO_URI", "app.config['MONGO_URI'] = 'mongodb://mongo:hygtHyPGodoUuHKliWxTdMhqRfkfMbYk@ballast.proxy.rlwy.net:49150/UserAuth?authSource=admin")
